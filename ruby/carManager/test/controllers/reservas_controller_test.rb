...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { carro: @reserva.carro, cliente: @reserva.cliente, cpf: @reserva.cpf, data_fim: @reserva.data_fim, data_inicio: @reserva.data_inicio } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { carro: @reserva.carro, cliente: @reserva.cliente, cpf: @reserva.cpf, data_fim: @reserva.data_fim, data_inicio: @reserva.data_inicio } }
